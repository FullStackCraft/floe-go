...
export default function Home() {
  ...
  const installCommand = "go get github.com/FullStackCraft/floe-go";
    ...
    <main className="min-h-screen overflow-y-auto flex flex-col items-center px-4 pt-14 md:pt-24 lg:pt-28 pb-8 md:pb-10">
      <div className="flex flex-col items-center w-full">
        <div className="text-center mb-20 md:mb-24">
          <h1 className="font-mono text-7xl md:text-8xl lg:text-9xl font-bold tracking-tight mb-6 text-[#00ADD8]">
            floe
          </h1>
      ...
      <footer className="pt-2 pb-4 text-sm text-gray-400 flex flex-col items-center gap-2">
        <div>
          <a
            href="https://github.com/FullStackCraft/floe-go"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="https://pkg.go.dev/github.com/FullStackCraft/floe-go"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-black transition-colors"
          >
        ...
        <div className="text-xs mt-1">
          <a
            href="https://fullstackcraft.github.io/floe/"
            className="hover:text-black transition-colors"
          >
